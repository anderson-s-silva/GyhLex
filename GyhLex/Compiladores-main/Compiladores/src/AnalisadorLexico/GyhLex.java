			...
			for(int i = 0; i < flexoes.length(); i++) {//Start for
				if(i != flexoes.length() - 1 && flexoes.charAt(i+1) == '=') {//if
					if(flexoes.charAt(i) == '=') {
						...
						System.out.println("=" + "ERROR: caractere inválido. Linha: " + this.cont_linhas + i);
						System.exit(1);
					}
					...
					System.out.println(Character.toString(flexoes.charAt(i))+" ERROR: caractere inválido. Linha: " + this.cont_linhas + i);
					System.exit(1);
				}
			}//end for
		}//end forzÃ£o
